...
describe("EmailAddresses", () => {
	...
	it("get primary", () => expect(model.EmailAddresses.get({ primary: "first.last@email.com" })).toEqual("first.last@email.com"))
	it("get billing", () => expect(model.EmailAddresses.get({ billing: "first.last@email.com" })).toEqual("first.last@email.com"))
})
