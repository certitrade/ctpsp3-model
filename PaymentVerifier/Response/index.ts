...
export namespace Response {
	export function verified(): Verified { return new RVerified() }
	export function unverified(): Unverified { return new RUnverified() }
	export function verificationRequired(visible: boolean, method: "GET" | "POST", url: string, data?: { [property: string]: string }): VerificationRequired {
		return new RVerificationRequired(visible,	method,	url,	data)
	}
	export function error(e: gracely.Error): Error { return new RError(e) }
