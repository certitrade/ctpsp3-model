...
describe("Settlement", () => {
	...
	it("toCsv 1 settlement with orders", () => {
		...
		expect(csvOutput).toEqual(
			"reference,start date,end date,payout date,gross,fee,net,currency\r\n" +
				...
				'"01234567abcd0000","2019-01-31T20:01:34","249","-7.5","241.5","charged refunded settled"\r\n' +
				'"01234567abcd0001","2019-01-31T20:01:34","249","-7.5","241.5","charged refunded settled"\r\n'
		)
	})
	it("toCsv several settlements without orders", () => {
		...
		expect(csvOutput).toEqual(
			"reference,start date,end date,payout date,gross,fee,net,currency\r\n" +
				'"example1","2020-02-01","2020-02-07","2020-02-09","498","-15","483","SEK"\r\n' +
				'"example2","2020-02-08","2020-02-15","","-249","-7.5","-256.5","SEK"\r\n'
		)
	})
	it("toCsv several settlements with orders", () => {
		...
		expect(csvOutput).toEqual(
			"reference,start date,end date,payout date,gross,fee,net,currency\r\n" +
				...
				'"example2","2020-02-08","2020-02-15","","-249","-7.5","-256.5","SEK"\r\n' +
				"number,created,gross,fee,net,status\r\n" +
				'"01234567abcd0000","2019-01-31T20:01:34","-124.5","-3.75","-128.25","charged refunded settled"\r\n' +
				'"01234567abcd0001","2019-01-31T20:01:34","-124.5","-3.75","-128.25","charged refunded settled"\r\n'
		)
	})
})
